...
public class TechnicianDashboard extends JFrame {
    ...
    private void initializeComponents() {
        ...
        setTitle("Technician Portal");

        headerPanel.setBackground(new java.awt.Color(255, 255, 255));

        logoLabel.setIcon(new ImageIcon(getClass().getResource("/images/Logo smaller.png")));

        technicianLabel.setFont(new java.awt.Font("Segoe UI Historic", 1, 24));
        technicianLabel.setForeground(new java.awt.Color(140, 82, 255));
        technicianLabel.setText("Technician Portal");

        welcomeLabel.setForeground(new java.awt.Color(140, 82, 255));
        welcomeLabel.setText("Welcome to the technician portal");

        iconLabel.setIcon(new ImageIcon(getClass().getResource("/images/Usericon (2).png")));
            ...
            headerPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                .addGroup(headerPanelLayout.createSequentialGroup()
                    ...
                    .addGroup(headerPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        ...
                        .addComponent(technicianLabel, GroupLayout.PREFERRED_SIZE, 256, GroupLayout.PREFERRED_SIZE))
                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(logoutBtn)
                    .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                    .addComponent(iconLabel, GroupLayout.PREFERRED_SIZE, 55, GroupLayout.PREFERRED_SIZE)
                    .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        scheduleBtn.setFont(new java.awt.Font("Segoe UI", 0, 14));
        ...
        reservationBtn.setFont(new java.awt.Font("Segoe UI", 0, 14));
    ...
    public static void main(String args[]) {
        new TechnicianDashboard("Technician").setVisible(true);
    }
}
